function [x,Fs,StartDate,StartTime,Label,Dimension,Cal,Off,NmbChans,N] = Readedf(fname,ch,t1,t2)
...
%	StartDate	date of the starting time of the recording [dd:mm:yy]
%	StartTime	time of the beginning of the recording [hh:mm:ss]
%	Label		signal label
%	Dimension	signal dimension
%   Cal
%   Off
%	NmbChans	number of channels in the file
...
[NmbChans,Label,Dimension,Coef,StartDate,StartTime,Nmb_blck,Blck_size,Hdr_size,~,~,~,~,Nmb_samps] = Readedfhdr(fid);
...
HH = str2double(StartTime(1:2));
MM = str2double(StartTime(4:5));
SS = str2double(StartTime(7:8));
